...
Deprivation, and Respiratory Health in the UK
...
WARDS_DATA_PATH = 'Wards_December_2024_Boundaries_UK_BFC_2423639173483005972.csv'
...
def load_data():
    ...
    wards_df = pd.read_csv(WARDS_DATA_PATH)
...
def analyze_environmental_justice(unified_df):
    ...
    print("\nCorrelation between air pollution and deprivation:")
    ...
    print(high_injustice[['lsoa_code', 'lsoa_name', 'lad_name', 'imd_score_normalized', 
...
def merge_health_with_pollution(unified_df, health_df):
    ...
    Returns:
        pd.DataFrame: Merged dataset at LAD level
    """
...
def analyze_health_pollution_relationship(merged_df):
    ...
    double_disadv = merged_df[merged_df['double_disadvantage']]['respiratory_health_index'].dropna()
    others = merged_df[~merged_df['double_disadvantage']]['respiratory_health_index'].dropna()
...
def create_vulnerability_index(merged_df):
    ...
    print(high_vulnerability[['lad_name', 'vulnerability_index', 'imd_score_normalized', 
